...
$productosDisponibles = RegistrarVentasUE::obtenerProductosDisponiblesPorSucursal($id_sucursal);
...
require_once __DIR__ . '/../../../views/usestandar/registrarVentaUE/registrarVentaUE.php';
exit;
