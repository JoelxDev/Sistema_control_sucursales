...
ORDER BY v.fecha_venta DESC
    ...
    try {
        ...
        error_log('Error obtenerProductosDisponiblesPorSucursal: ' . $e->getMessage());
        return [];
    }
}
}
