                ...
                <div class="form-Edit-Producto">
                    <form
                        ...
                        <input type="number" name="txtprecio_pr"
                            value="<?= htmlspecialchars($producto['precio_unitario_pr']) ?>" step="0.01" required><br>
