...
require_once __DIR__ . '/../../../controllers/us_administrador/inventario/vistaInventario.php';
...
<body>
    ...
    <div class="content">
        ...
        <div class="cuerpo">
            <div class="main-body-inventario">
                <div class="upper-body" id="">
                    <div>
                                            ...
                                            <div class="productos-lista">
                                                <?php foreach ($inventariosSucursal as $inv): ?>
                                                    <div class="producto-card">
                                                        <div class="producto-nombre"><?= htmlspecialchars($inv['producto']) ?>
                                                        </div>
                                                        <div class="producto-cantidad">Cantidad total:
                                                            <b><?= htmlspecialchars($inv['cantidad_total']) ?></b>
                                                        </div>
                                                        <div class="producto-fecha">Última actualización:
                                                            <span><?= htmlspecialchars($inv['ultima_actualizacion']) ?></span>
                                                        </div>
                                                        <div class="producto-epoca">Época:
                                                            <?= htmlspecialchars($inv['epoca']) ?></div>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
